import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css                  *//* empty css                          */import{t as H,o as _,s as B,a as P,c as F}from"./footer-VPaacqP9.js";/* empty css                        */import"./state-DFY6wBk_.js";import"./config-DYBXrzFk.js";import"./playcanvas-D5Kv4vzz.js";const O=[{image:"/images/Network.webp",youtubeId:"BCEdZVVwBC4",youtubeIdMobile:"AL1UjxlcHo0",title:"NET-WORK",subtitle:"Latticework & Light",eyebrow:"The Net-Work Series",objectPosition:"center 50%",link:"/collection.html?id=networking"},{image:"/images/Atlas.webp",youtubeId:"PkF5YGPu_YI",youtubeIdMobile:"8sbb6UZwZC4",startTime:2,title:"MONUMENTAL",subtitle:"Where Geometry Bears the Weight of Myth",eyebrow:"Polygonal & Hercules",objectPosition:"center 30%",link:"/collection.html?id=monumental"},{image:"/images/Forge.webp",youtubeId:"-EINfzSwMeg",youtubeIdMobile:"XH2j7ZigZyE",title:"THE FORGE",subtitle:"Where Steel Becomes Spirit",eyebrow:"Nikola Vudrag",objectPosition:"center 35%",link:"/gallery.html"}];async function R(){try{const e=await fetch("/api/site-content");if(!e.ok)throw new Error("CMS unavailable");const t=await e.json();if(t.heroSlides&&t.heroSlides.length>0)return t.heroSlides}catch{console.warn("⚠️ Could not fetch hero slides from CMS, using fallback")}return O}function Y(e){const i=window.innerWidth<window.innerHeight&&e.youtubeIdMobile?e.youtubeIdMobile:e.youtubeId;if(!i)return"";const s=["autoplay=1","mute=1","loop=1","controls=0","showinfo=0","modestbranding=1","rel=0","disablekb=1","iv_load_policy=3","playsinline=1",`playlist=${i}`,"enablejsapi=1","origin="+encodeURIComponent(window.location.origin),...e.startTime?[`start=${e.startTime}`]:[]].join("&");return`https://www.youtube.com/embed/${i}?${s}`}function N(e,t){const i=Y(e);return i?`
    ...
    `,t.forEach(i=>{if(i.image){const s=new Image;s.src=i.image}}),D(e),V(e),G(e),console.log("🎬 Hero slider initialized —",t.length,"slides (lazy video loading)")}function z(e){const t=e.querySelector(".hero-slide__video");!t||!t.dataset.src||t.getAttribute("src")!==t.dataset.src&&(t.src=t.dataset.src)}function W(e){const t=e.querySelector(".hero-slide__video");t&&t.removeAttribute("src")}function D(e){const t=e.querySelectorAll(".hero-slide"),i=e.querySelectorAll(".hero-pagination__dot");let s=0;const a=new IntersectionObserver(o=>{o.forEach(l=>{var c,n,u;const p=parseInt(l.target.dataset.index,10);if(l.isIntersecting&&l.intersectionRatio>=.5){if(p===s)return;(c=t[s])==null||c.classList.remove("is-active"),(n=i[s])==null||n.classList.remove("is-active"),W(t[s]),s=p,l.target.classList.add("is-active"),(u=i[p])==null||u.classList.add("is-active"),z(l.target)}})},{root:e,threshold:[.1,.5]});t.forEach(o=>a.observe(o))}function V(e){e.querySelectorAll(".hero-pagination__dot").forEach(i=>{i.addEventListener("click",()=>{const s=parseInt(i.dataset.index,10),a=e.querySelectorAll(".hero-slide")[s];a&&a.scrollIntoView({behavior:"smooth",block:"start"})})})}function G(e){let t=0;const i=80,s=60;let a=!1;const o=e.querySelector(".hero-pagination");function l(){return e.scrollTop+e.clientHeight>=e.scrollHeight-5}function p(){e.style.overflowY="hidden",e.style.scrollSnapType="none",o&&(o.style.opacity="0")}function c(){e.style.overflowY="",e.style.scrollSnapType="",o&&(o.style.opacity="")}function n(){a=!0,t=0,p();const d=document.getElementById("content-area");d&&d.scrollIntoView({behavior:"smooth",block:"start"})}e.addEventListener("wheel",d=>{if(!a){if(l()&&d.deltaY>0){t+=d.deltaY,t>=i&&n();return}t=0}},{passive:!0});let u=0,r=!1;e.addEventListener("touchstart",d=>{a||(u=d.touches[0].clientY,r=!0,t=0)},{passive:!0}),e.addEventListener("touchmove",d=>{if(a||!r)return;const h=d.touches[0].clientY,v=u-h;if(l()&&v>0){t+=v,u=h,t>=s&&(n(),r=!1);return}t=0,u=h},{passive:!0}),e.addEventListener("touchend",()=>{r=!1,t=0},{passive:!0}),window.addEventListener("scroll",()=>{a&&window.scrollY<=5&&(a=!1,c())},{passive:!0})}let y=null,C=null,$=null,S=!1;const X={LOGO_TEXT:"VUDRAG"};function U(){y=document.createElement("header"),y.className="sticky-header",y.innerHTML=`
    ...
    `}function se(e){const t=c=>{const n=e.getBoundingClientRect(),u=(c.clientX-n.left)/n.width-.5,r=(c.clientY-n.top)/n.height-.5,d=-r*m.maxRotation,h=u*m.maxRotation;e.style.transform=`
        ...
        `,A(e,u,r)},i=()=>{k=e,e.style.transition=`transform ${m.trackingSpeed}s cubic-bezier(0.25, 0.46, 0.45, 0.94)`},s=()=>{k=null,e.style.transition=`transform ${m.transitionSpeed}s ease-out`,e.style.transform="perspective(1000px) rotateX(0) rotateY(0) scale3d(1, 1, 1)";const c=e.querySelector(".category-card__shine");c&&(c.style.opacity="0")},a=c=>{k=e,e.style.transition=`transform ${m.trackingSpeed}s cubic-bezier(0.25, 0.46, 0.45, 0.94)`},o=c=>{if(k!==e)return;const n=c.touches[0],u=e.getBoundingClientRect(),r=(n.clientX-u.left)/u.width-.5,d=(n.clientY-u.top)/u.height-.5,h=Math.max(-.5,Math.min(.5,r)),v=Math.max(-.5,Math.min(.5,d)),b=-v*m.maxRotation,E=h*m.maxRotation;e.style.transform=`
            perspective(${m.perspective}px)
            rotateX(${b}deg)
            rotateY(${E}deg)
            scale3d(${m.scale}, ${m.scale}, ${m.scale})
        `,A(e,h,v)},l=()=>{k=null,e.style.transition=`transform ${m.transitionSpeed}s ease-out`,e.style.transform="perspective(1000px) rotateX(0) rotateY(0) scale3d(1, 1, 1)";const c=e.querySelector(".category-card__shine");c&&(c.style.opacity="0")};e.addEventListener("mousemove",t),e.addEventListener("mouseenter",i),e.addEventListener("mouseleave",s),e.addEventListener("touchstart",a,{passive:!0}),e.addEventListener("touchmove",o,{passive:!0}),e.addEventListener("touchend",l),e.addEventListener("touchcancel",l);const p=document.createElement("div");p.className="category-card__shine",p.style.cssText=`
        position: absolute;
        top: 0;
        left: 0;
        right: 0;
    ...
    `}function he(e){const t=a=>{const o=e.getBoundingClientRect(),l=(a.clientX-o.left)/o.width-.5,p=(a.clientY-o.top)/o.height-.5,c=-p*w.maxRotation,n=l*w.maxRotation;e.style.transform=`
        ...
        `;const u=e.querySelector(".works-card__shine");if(u){const r=(l+.5)*100,d=(p+.5)*100;u.style.background=`radial-gradient(
                ...
                rgba(255, 255, 255, 0.15) 0%,
                transparent 50%
            )`,u.style.opacity="1"}},i=()=>{e.style.transition="transform 0.15s ease-out"},s=()=>{e.style.transition=`transform ${w.transitionSpeed}s ease-out`,e.style.transform="perspective(1200px) rotateX(0) rotateY(0) scale3d(1, 1, 1)";const a=e.querySelector(".works-card__shine");a&&(a.style.opacity="0")};e.addEventListener("mousemove",t),e.addEventListener("mouseenter",i),e.addEventListener("mouseleave",s)}const me="/api";let q=[];const ge=[{id:"dubai-build-impossible",title:"Dubai — Build The Impossible",category:"Exhibition",youtubeId:"7-uhfMFcx7Y"},{id:"thompson-coin-necklace",title:"Thompson Coin Necklace",category:"Process",youtubeId:"rIlK_HQCXF4"},{id:"vudrag-legacy-trailer",title:"Vudrag Legacy Trailer",category:"Film",youtubeId:"ra1X5YLkFi0"},{id:"dubai-hedonist-gallery",title:"Dubai Hedonist Gallery — Opening Ceremony",category:"Exhibition",youtubeId:"rnDmBogTZy4"},{id:"thompson-coin",title:"Thompson Coin",category:"Process",youtubeId:"sWl-7BQHmC4"},{id:"kovnica-novca",title:"Kovnica Novca",category:"Documentary",youtubeId:"jkFG8-GsZq8"}];async function fe(){try{const e=await fetch(`${me}/films`);if(!e.ok)throw new Error(`HTTP ${e.status}`);return(await e.json()).map(i=>({...i,thumbnail:i.youtubeId?`https://img.youtube.com/vi/${i.youtubeId}/maxresdefault.jpg`:""}))}catch(e){return console.warn("⚠️ Films API unavailable, using fallback data:",e.message),ge.map(t=>({...t,thumbnail:`https://img.youtube.com/vi/${t.youtubeId}/maxresdefault.jpg`}))}}async function ve(){const e=document.getElementById("content-area");if(!e)return console.warn("⚠️ Content area not found for film showcase"),null;const t=await fe();q=t;const i=ye(t);e.appendChild(i),we(i),be(i);const s=i.querySelector(".film-showcase__header");s&&_(s),i.querySelectorAll(".film-strip").forEach((l,p)=>{l.setAttribute("data-reveal","true"),l.setAttribute("data-reveal-delay",String(p+1)),_(l)}),ke(i);const o=i.querySelector(".film-showcase__expand");return o&&_(o),console.log("🎬 Film showcase (Cinematic Scroll) initialized"),i}function ye(e){const t=document.createElement("section");t.className="film-showcase",t.id="film-showcase",t.innerHTML=`
    ...
    `}function we(e){const t=e.querySelectorAll(".film-strip");if(!t.length)return;const i=document.getElementById("content-area")||window;let s=!1;function a(){const l=window.innerHeight/2,p=window.innerHeight*.6;let c=null,n=1/0;const u=[];for(let r=0;r<t.length;r++){const d=t[r],h=d.getBoundingClientRect(),v=h.top+h.height/2,b=Math.abs(v-l),E=Math.max(0,1-b/p);u.push({strip:d,distance:b,proximity:E}),b<n&&(n=b,c=d)}for(let r=0;r<u.length;r++){const{strip:d,proximity:h}=u[r];d.style.setProperty("--proximity",h.toFixed(3)),d===c&&h>.3?d.classList.add("is-active"):d.classList.remove("is-active")}}function o(){s||(s=!0,requestAnimationFrame(()=>{a(),s=!1}))}i!==window&&i&&i.addEventListener("scroll",o,{passive:!0}),window.addEventListener("scroll",o,{passive:!0}),window.addEventListener("resize",o,{passive:!0}),requestAnimationFrame(()=>{a()})}function be(e){const t=document.querySelector(".film-lightbox");if(!t)return;const i=t.querySelector(".film-lightbox__backdrop"),s=t.querySelector(".film-lightbox__close"),a=t.querySelector(".film-lightbox__player"),o=t.querySelector(".film-lightbox__title"),l=t.querySelector(".film-lightbox__category"),p=t.querySelector(".film-lightbox__meta");function c(r){o.textContent=r.title,l.textContent=r.category,p.textContent=r.category,r.youtubeId?a.innerHTML=`
                <iframe 
            ...
            `,t.classList.add("is-open"),document.body.style.overflow="hidden"}function n(){t.classList.remove("is-open"),document.body.style.overflow="",setTimeout(()=>{a.innerHTML=""},400)}e.querySelectorAll(".film-strip").forEach(r=>{r.addEventListener("click",()=>{const d=r.dataset.filmId,h=q.find(v=>v.id===d);h&&c(h)})}),s.addEventListener("click",n),i.addEventListener("click",n),document.addEventListener("keydown",r=>{r.key==="Escape"&&t.classList.contains("is-open")&&n()})}function ke(e){const t=e.querySelector(".film-showcase__strips-wrapper"),i=e.querySelector(".film-showcase__expand-btn"),s=e.querySelector(".film-showcase__expand");if(!t||!i)return;let a=!1;i.addEventListener("click",()=>{if(a=!a,a){const l=t.querySelector(".film-showcase__strips").scrollHeight;t.style.maxHeight=l+"px",t.classList.remove("film-showcase__strips-wrapper--collapsed"),t.classList.add("film-showcase__strips-wrapper--expanded"),s.querySelector(".film-showcase__expand-text").textContent="Show less",s.classList.add("film-showcase__expand--flipped")}else t.style.maxHeight="",t.classList.add("film-showcase__strips-wrapper--collapsed"),t.classList.remove("film-showcase__strips-wrapper--expanded"),s.querySelector(".film-showcase__expand-text").textContent="Explore all films",s.classList.remove("film-showcase__expand--flipped"),e.scrollIntoView({behavior:"smooth",block:"start"})})}async function Se(){console.log("🎨 Initializing Vudrag Gallery Experience..."),await j(),Ee(),console.log("✅ Hero ready — loading screen dismissed"),(window.requestIdleCallback||(t=>setTimeout(t,1)))(()=>{xe().then(()=>{console.log("✅ All sections loaded")})},{timeout:1e3})}async function xe(){U(),B(),await ee(),await re(),await ve(),await de(),await P(),F()}function Ee(){const e=document.getElementById("loading-screen");setTimeout(()=>{e.classList.add("loaded")},600)}window.addEventListener("error",e=>console.error("Error:",e.error));Se().catch(console.error);
