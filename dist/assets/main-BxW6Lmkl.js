import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css                  *//* empty css                          */import"./config-C-p27o92.js";import{s as k}from"./state-DFY6wBk_.js";import{_ as D}from"./playcanvas-SM2qEX5e.js";const G=[{image:"/images/VUDRAG-BOOK-MMXXV_Page_03_Image_0001.webp",youtubeId:"-EINfzSwMeg",youtubeIdMobile:"XH2j7ZigZyE",title:"THE FORGE",subtitle:"Where Steel Becomes Spirit",eyebrow:"Nikola Vudrag",objectPosition:"center 35%",link:"/gallery.html"},{image:"/images/VUDRAG-BOOK-MMXXV_Page_20_Image_0001.webp",youtubeId:"BCEdZVVwBC4",youtubeIdMobile:"AL1UjxlcHo0",title:"NETWORKING",subtitle:"Latticework & Light",eyebrow:"The Net-Work Series",objectPosition:"center 50%",link:"/gallery.html"},{image:"/images/VUDRAG-BOOK-MMXXV_Page_40_Image_0001.webp",youtubeId:"PkF5YGPu_YI",youtubeIdMobile:"8sbb6UZwZC4",startTime:2,title:"ATLAS",subtitle:"The Weight of the World",eyebrow:"The Labours of Hercules",objectPosition:"center 30%",link:"/gallery.html"}];async function j(){try{const e=await fetch("/api/site-content");if(!e.ok)throw new Error("CMS unavailable");const t=await e.json();if(t.heroSlides&&t.heroSlides.length>0)return t.heroSlides}catch{console.warn("⚠️ Could not fetch hero slides from CMS, using fallback")}return G}function X(e){const o=window.innerWidth<window.innerHeight&&e.youtubeIdMobile?e.youtubeIdMobile:e.youtubeId;if(!o)return"";const i=["autoplay=1","mute=1","loop=1","controls=0","showinfo=0","modestbranding=1","rel=0","disablekb=1","iv_load_policy=3","playsinline=1",`playlist=${o}`,"enablejsapi=1","origin="+encodeURIComponent(window.location.origin),...e.startTime?[`start=${e.startTime}`]:[]].join("&");return`https://www.youtube.com/embed/${o}?${i}`}function Y(e,t){const o=X(e);return o?`
    ...
    `,document.body.appendChild(v),v.querySelector(".menu-close").addEventListener("click",O),v.querySelectorAll(".menu-link").forEach(o=>{o.addEventListener("click",te)}),window.addEventListener("toggle-menu",V),console.log("🍔 Menu overlay created")}function ee(){v||N(),H=!0,v.classList.add("visible"),document.body.style.overflow="hidden"}function O(){v&&(H=!1,v.classList.remove("visible"),document.body.style.overflow="")}function V(){H?O():ee()}function te(e){const t=e.target.getAttribute("data-target");t&&(e.preventDefault(),O(),B(t))}let y=null,M=null,A=null,L=!1;const oe={LOGO_TEXT:"VUDRAG"};function ie(){y=document.createElement("header"),y.className="sticky-header",y.innerHTML=`
    ...
    `,e.querySelectorAll(".category-card").forEach(o=>{o.addEventListener("click",()=>{const i=o.dataset.category;ve(i)})}),e}function ge(e){return`
    ...
    `}function fe(e){const t=l=>{const r=e.getBoundingClientRect(),u=(l.clientX-r.left)/r.width-.5,d=(l.clientY-r.top)/r.height-.5,h=-d*m.maxRotation,p=u*m.maxRotation;e.style.transform=`
    ...
    `,e.appendChild(t);const o=t.querySelector(".footer__links");Re.forEach(s=>{const a=document.createElement("a");a.href=s.href,a.className="footer__link",s.href.startsWith("#")&&(a.dataset.target=s.href.substring(1)),a.innerHTML=`
        ...
        `,i.appendChild(a)}),Ve(t),console.log("✅ Footer initialized")}function Ne(e){return{instagram:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
