import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css                  *//* empty css                          */import"./config-C-p27o92.js";import{s as S}from"./state-DFY6wBk_.js";import{_ as D}from"./playcanvas-SM2qEX5e.js";const G=[{image:"/images/VUDRAG-BOOK-MMXXV_Page_03_Image_0001.webp",youtubeId:"-EINfzSwMeg",youtubeIdMobile:"XH2j7ZigZyE",title:"THE FORGE",subtitle:"Where Steel Becomes Spirit",eyebrow:"Nikola Vudrag",objectPosition:"center 35%",link:"/gallery.html"},{image:"/images/VUDRAG-BOOK-MMXXV_Page_20_Image_0001.webp",youtubeId:"BCEdZVVwBC4",youtubeIdMobile:"AL1UjxlcHo0",title:"NETWORKING",subtitle:"Latticework & Light",eyebrow:"The Net-Work Series",objectPosition:"center 50%",link:"/gallery.html"},{image:"/images/VUDRAG-BOOK-MMXXV_Page_40_Image_0001.webp",youtubeId:"PkF5YGPu_YI",youtubeIdMobile:"8sbb6UZwZC4",startTime:2,title:"ATLAS",subtitle:"The Weight of the World",eyebrow:"The Labours of Hercules",objectPosition:"center 30%",link:"/gallery.html"}];async function Y(){try{const e=await fetch("/api/site-content");if(!e.ok)throw new Error("CMS unavailable");const t=await e.json();if(t.heroSlides&&t.heroSlides.length>0)return t.heroSlides}catch{console.warn("⚠️ Could not fetch hero slides from CMS, using fallback")}return G}function j(e){const o=window.innerWidth<window.innerHeight&&e.youtubeIdMobile?e.youtubeIdMobile:e.youtubeId;if(!o)return"";const s=["autoplay=1","mute=1","loop=1","controls=0","showinfo=0","modestbranding=1","rel=0","disablekb=1","iv_load_policy=3","playsinline=1",`playlist=${o}`,"enablejsapi=1","origin="+encodeURIComponent(window.location.origin),...e.startTime?[`start=${e.startTime}`]:[]].join("&");return`https://www.youtube.com/embed/${o}?${s}`}function X(e,t){const o=j(e);return o?`
    ...
    `,document.body.appendChild(v),v.querySelector(".menu-close").addEventListener("click",O),v.querySelectorAll(".menu-link").forEach(o=>{o.addEventListener("click",oe)}),window.addEventListener("toggle-menu",V),console.log("🍔 Menu overlay created")}function te(){v||N(),H=!0,v.classList.add("visible"),document.body.style.overflow="hidden"}function O(){v&&(H=!1,v.classList.remove("visible"),document.body.style.overflow="")}function V(){H?O():te()}function oe(e){const t=e.target.getAttribute("data-target");t&&(e.preventDefault(),O(),B(t))}let y=null,M=null,A=null,x=!1;const se={LOGO_TEXT:"VUDRAG"};function ie(){y=document.createElement("header"),y.className="sticky-header",y.innerHTML=`
    ...
    `}function $e(e){const t=i=>{const a=e.getBoundingClientRect(),n=(i.clientX-a.left)/a.width-.5,c=(i.clientY-a.top)/a.height-.5,l=-c*b.maxRotation,r=n*b.maxRotation;e.style.transform=`
        ...
        `;const u=e.querySelector(".works-card__shine");if(u){const d=(n+.5)*100,h=(c+.5)*100;u.style.background=`radial-gradient(
                ...
                rgba(255, 255, 255, 0.15) 0%,
                transparent 50%
            )`,u.style.opacity="1"}},o=()=>{e.style.transition="transform 0.15s ease-out"},s=()=>{e.style.transition=`transform ${b.transitionSpeed}s ease-out`,e.style.transform="perspective(1200px) rotateX(0) rotateY(0) scale3d(1, 1, 1)";const i=e.querySelector(".works-card__shine");i&&(i.style.opacity="0")};e.addEventListener("mousemove",t),e.addEventListener("mouseenter",o),e.addEventListener("mouseleave",s)}const Ae="/api";let z=[];const Me=[{id:"dubai-build-impossible",title:"Dubai — Build The Impossible",category:"Exhibition",youtubeId:"7-uhfMFcx7Y"},{id:"thompson-coin-necklace",title:"Thompson Coin Necklace",category:"Process",youtubeId:"rIlK_HQCXF4"},{id:"vudrag-legacy-trailer",title:"Vudrag Legacy Trailer",category:"Film",youtubeId:"ra1X5YLkFi0"},{id:"dubai-hedonist-gallery",title:"Dubai Hedonist Gallery — Opening Ceremony",category:"Exhibition",youtubeId:"rnDmBogTZy4"},{id:"thompson-coin",title:"Thompson Coin",category:"Process",youtubeId:"sWl-7BQHmC4"},{id:"kovnica-novca",title:"Kovnica Novca",category:"Documentary",youtubeId:"jkFG8-GsZq8"}];async function Ie(){try{const e=await fetch(`${Ae}/films`);if(!e.ok)throw new Error(`HTTP ${e.status}`);return(await e.json()).map(o=>({...o,thumbnail:o.youtubeId?`https://img.youtube.com/vi/${o.youtubeId}/maxresdefault.jpg`:""}))}catch(e){return console.warn("⚠️ Films API unavailable, using fallback data:",e.message),Me.map(t=>({...t,thumbnail:`https://img.youtube.com/vi/${t.youtubeId}/maxresdefault.jpg`}))}}async function Te(){const e=document.getElementById("content-area");if(!e)return console.warn("⚠️ Content area not found for film showcase"),null;const t=await Ie();z=t;const o=qe(t);e.appendChild(o),He(o),Oe(o);const s=o.querySelector(".film-showcase__header");s&&_(s),o.querySelectorAll(".film-strip").forEach((n,c)=>{n.setAttribute("data-reveal","true"),n.setAttribute("data-reveal-delay",String(c+1)),_(n)}),Pe(o);const a=o.querySelector(".film-showcase__expand");return a&&_(a),console.log("🎬 Film showcase (Cinematic Scroll) initialized"),o}function qe(e){const t=document.createElement("section");t.className="film-showcase",t.id="film-showcase",t.innerHTML=`
    ...
    `,document.body.appendChild(o),t}function Be(e,t){return`
    ...
    `}function He(e){const t=e.querySelectorAll(".film-strip");if(!t.length)return;const o=document.getElementById("content-area")||window;let s=!1;function i(){const n=window.innerHeight/2,c=window.innerHeight*.6;let l=null,r=1/0;const u=[];for(let d=0;d<t.length;d++){const h=t[d],p=h.getBoundingClientRect(),w=p.top+p.height/2,k=Math.abs(w-n),$=Math.max(0,1-k/c);u.push({strip:h,distance:k,proximity:$}),k<r&&(r=k,l=h)}for(let d=0;d<u.length;d++){const{strip:h,proximity:p}=u[d];h.style.setProperty("--proximity",p.toFixed(3)),h===l&&p>.3?h.classList.add("is-active"):h.classList.remove("is-active")}}function a(){s||(s=!0,requestAnimationFrame(()=>{i(),s=!1}))}o!==window&&o&&o.addEventListener("scroll",a,{passive:!0}),window.addEventListener("scroll",a,{passive:!0}),window.addEventListener("resize",a,{passive:!0}),requestAnimationFrame(()=>{i()})}function Oe(e){const t=document.querySelector(".film-lightbox");if(!t)return;const o=t.querySelector(".film-lightbox__backdrop"),s=t.querySelector(".film-lightbox__close"),i=t.querySelector(".film-lightbox__player"),a=t.querySelector(".film-lightbox__title"),n=t.querySelector(".film-lightbox__category"),c=t.querySelector(".film-lightbox__meta");function l(d){a.textContent=d.title,n.textContent=d.category,c.textContent=d.category,d.youtubeId?i.innerHTML=`
                <iframe 
            ...
            `,t.classList.add("is-open"),document.body.style.overflow="hidden"}function r(){t.classList.remove("is-open"),document.body.style.overflow="",setTimeout(()=>{i.innerHTML=""},400)}e.querySelectorAll(".film-strip").forEach(d=>{d.addEventListener("click",()=>{const h=d.dataset.filmId,p=z.find(w=>w.id===h);p&&l(p)})}),s.addEventListener("click",r),o.addEventListener("click",r),document.addEventListener("keydown",d=>{d.key==="Escape"&&t.classList.contains("is-open")&&r()})}function Pe(e){const t=e.querySelector(".film-showcase__strips-wrapper"),o=e.querySelector(".film-showcase__expand-btn"),s=e.querySelector(".film-showcase__expand");if(!t||!o)return;let i=!1;o.addEventListener("click",()=>{if(i=!i,i){const n=t.querySelector(".film-showcase__strips").scrollHeight;t.style.maxHeight=n+"px",t.classList.remove("film-showcase__strips-wrapper--collapsed"),t.classList.add("film-showcase__strips-wrapper--expanded"),s.querySelector(".film-showcase__expand-text").textContent="Show less",s.classList.add("film-showcase__expand--flipped")}else t.style.maxHeight="",t.classList.add("film-showcase__strips-wrapper--collapsed"),t.classList.remove("film-showcase__strips-wrapper--expanded"),s.querySelector(".film-showcase__expand-text").textContent="Explore all films",s.classList.remove("film-showcase__expand--flipped"),e.scrollIntoView({behavior:"smooth",block:"start"})})}const Re=[{name:"Instagram",icon:"instagram",url:"https://www.instagram.com/vudrag_art/"},{name:"Facebook",icon:"facebook",url:"https://web.facebook.com/nikola.vudrag.77"},{name:"Interview",icon:"article",url:"https://www.contemporaryartissue.com/a-conversation-with-nikola-vudrag/"}],Fe=[{label:"Collections",href:"#category-hub"},{label:"Artist",href:"#artist-section"},{label:"Inquire",href:"/contact.html"},{label:"Collectors Club",href:"/login.html"}];async function Ne(){const e=document.getElementById("content-area");if(!e||document.getElementById("main-footer"))return;const t=document.createElement("footer");t.id="main-footer",t.className="site-footer",t.innerHTML=`
    ...
    `,e.appendChild(t);const o=t.querySelector(".footer__links");Fe.forEach(i=>{const a=document.createElement("a");a.href=i.href,a.className="footer__link",i.href.startsWith("#")&&(a.dataset.target=i.href.substring(1)),a.innerHTML=`
            ${i.label}
            <span class="footer__link-arrow">→</span>
        `,o.appendChild(a)});const s=t.querySelector(".footer__social");Re.forEach(i=>{const a=document.createElement("a");a.href=i.url,a.className="footer__social-link",a.target="_blank",a.rel="noopener noreferrer",a.ariaLabel=i.name,a.innerHTML=`
            ${Ve(i.icon)}
            <div class="footer__social-glow"></div>
        `,s.appendChild(a)}),ze(t),console.log("✅ Footer initialized")}function Ve(e){return{instagram:`<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
