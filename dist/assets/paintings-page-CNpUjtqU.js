async function Q(a,s){const{pageContent:d,works:i=[],segments:o=[]}=s,{hero:r={},introduction:u={},technique:p={}}=d||{};a.innerHTML=G(s,r,u,i,p),requestAnimationFrame(()=>{V(a),U(a),J(a)})}function G(a,s,d,i,o){return`
        ${j(s)}
        ${F(d)}
        ${N(i)}
        ${A(o)}
    `}function j(a){return a.title?`
